...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; diff
   `(diff-header ((,class (:foreground ,fg2 :background ,bg3))))
   `(diff-file-header ((t (:inherit diff-header))))
   `(diff-index ((t (:inherit diff-file-header))))
   `(diff-added ((,class (:background ,bg1 :foreground ,str))))
   `(diff-changed ((t (:background ,bg1 :foreground ,fg1))))
   `(diff-removed ((,class (:background ,bg1 :foreground ,warning))))
   ...
   ;; ediff
   `(ediff-current-diff-A ((t (:inherit diff-removed :bold t))))
   `(ediff-current-diff-Ancestor ((t (:inherit ediff-current-diff-A))))
   `(ediff-current-diff-B ((t (:inherit diff-added :bold t))))
   `(ediff-current-diff-C ((t (:inherit diff-changed :bold t))))
   `(ediff-fine-diff-A ((t (:inherit ediff-current-diff-A :inverse-video t))))
   `(ediff-fine-diff-Ancestor ((t (:inherit ediff-fine-diff-A :inverse-video t))))
   ...
   `(ediff-even-diff-Ancestor ((t (:inherit ediff-even-diff-A :bold nil))))
   `(ediff-even-diff-B ((t (:inherit ediff-current-diff-B :bold nil))))
   `(ediff-even-diff-C ((t (:inherit ediff-current-diff-C :bold nil))))
   `(ediff-odd-diff-A ((t (:inherit ediff-even-diff-A :bold nil))))
   `(ediff-odd-diff-Ancestor ((t (:inherit ediff-odd-diff-A :bold nil))))
   `(ediff-odd-diff-B ((t (:inherit ediff-even-diff-B :bold nil))))
   `(ediff-odd-diff-C ((t (:inherit ediff-even-diff-C :bold nil))))
   ;; enh-ruby
